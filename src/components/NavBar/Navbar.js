...
import "./navbar.css";
import logo from '../../assets/imgbg.png'
...
const Navbar = () => {
  ...
  <nav className="navbar">
   ...
   <button className='desktopMenuBtn' onClick={() =>{
    ...
    <img src={contactImg} alt="" srcset="" className='desktopMenuImg'/> Contact Me

   </button>

   <img src={Menu} alt="" srcset="" className='mobMenu' onClick={() =>setShowMenu(!showMenu)} />
